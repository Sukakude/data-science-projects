...
def main(config: str, min_accuracy: float):
    ...
    if deploy:
        continuous_deployment_pipeline(min_accuracy, 3, 40)
    ...
    # FETCH EXISTING SERVICES WITH THE SAME PIPELINE
    ...
    if existing_services:
        ...
        print(
            ...
            'pipeline must run first to train the model and deploy it. Execute '
